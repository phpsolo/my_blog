...
<div class="margin" id="page_style">
	<div class="operation clearfix">
		...
		<span class="submenu"><a href="{{url('/Admin/Article/create')}}" name="{{url('/Admin/Article/create')}}" class="btn button_btn bg-deep-blue" title="添加文章"><i class="fa  fa-edit"></i>&nbsp;添加文章</a></span>
		<div class="search  clearfix">
			<label class="label_name">文章搜索：</label><input name="" type="text"  class="form-control col-xs-6"/><button class="btn button_btn bg-deep-blue " onclick=""  type="button"><i class="fa  fa-search"></i>&nbsp;搜索</button>
		</div>
	</div>
	<!--列表展示-->
		...
		<table class="table table_list table_striped table-bordered" id="sample-table">
			...
			<tbody>
				<tr>
					...
					<td></td>
					<td>
						<a href="javascript:ovid()" class="btn bg-green operation_btn">查看</a> 
